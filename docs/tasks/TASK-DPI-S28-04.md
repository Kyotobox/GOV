...
## Objetivos
- [x] Investigar las fórmulas actuales en `gov.dart`, `telemetry_service.dart` e `integrity_engine.dart`.
- [x] Documentar el cálculo del **CUS (Context Utilization Score)** incluyendo penalizaciones de S27.
- [x] Documentar el cálculo del **BHI (Bunker Health Index)** con la ponderación 70/30 (Integridad/Higiene).
- [ ] Definir los umbrales de saturación y las acciones automáticas disparadas (Hard Gates).
- [x] Publicar el documento en `docs/gate-gold/PROTOCOLO_CALCULO.md`.
